<?php
	...
	$query = 'SELECT userId FROM questionComments WHERE id='.$commentId;
	...
	$delete = 'DELETE FROM questionComments WHERE id='.$commentId;

	mysql_query($delete);

	echo '
		<script type="text/javascript">
			$(\'.questionCommentDelete[id="'.$commentId.'"]\').remove();
		</script>
	';
?>