...
<html lang="en">
	...
	<body>
		...
		$(document).ready(function(){
			window.fbAsyncInit = function() {
				...
				FB.ui(
				{
					...
					link: 'http://www.torquextreme.com/review.php?id=<?php echo $_SESSION['shareId']; ?>',
					picture: 'http://www.torquextreme.com/icon.png'
					}, function(response) {
						window.location="http://www.torquextreme.com/review.php?id=<?php echo $_SESSION['shareId']; ?>";
					}
				);
			};
		...
		<input type="hidden" id="caption" value="<?php echo $_SESSION['shareName'] ?> wrote a review on Torque Xtreme" />

		<input type="hidden" id="title" value="<?php echo $_SESSION['shareTitle'] ;?>" />

		<input type="hidden" id="desc" value="<?php echo $_SESSION['shareDesc']; ?>" />

		<p id="message">Your review has been posted. Would you like to share this on Facebook? (Must have popups enabled)</p>
		
		<p><a href="review.php?id=<?php echo $_SESSION['shareId']; ?>" style="text-decoration:none;color:#c92828;font-size:14px;">No, take me to the review.</a></p>
	</body>
</html>