...
<html lang="en">
	<head>
		...
		<title>Answer Empty | Torque Xtreme</title>
	...
	<body>
		...
		<div id="container">
			<div id="right">
				...
				<p style="font-family:Armata;text-align:center;">Answer cannot be empty. If you're attaching an image, make sure it's valid and not larger than 3 MB.</p>
			</div>
