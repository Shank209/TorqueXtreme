...
<html lang="en">
	<head>
		...
		<title>Share Your Question | Torque Xtreme</title>

		<mate name="description" content="Share your question with your friends on facebook." />
	...
	<body>
		...
		<input type="hidden" id="caption" value="<?php echo $_SESSION['shareName'] ?> asked a question on Torque Xtreme" />

		<input type="hidden" id="title" value="<?php echo $_SESSION['shareTitle'] ;?>" />

		<input type="hidden" id="desc" value="<?php echo $_SESSION['shareDesc']; ?>" />

		<p id="message">Your question has been posted. Would you like to share this on Facebook? (Must have popups enabled)</p>
		
		<p><a href="question.php?id=<?php echo $_SESSION['shareId']; ?>" style="text-decoration:none;color:#c92828;font-size:14px;">No, take me to the question.</a></p>
	</body>
</html>