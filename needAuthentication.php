...
<html lang="en">
	<head>
		...
		<title>Need An Account | Torque Xtreme</title>

		<meta name="description" content="An account is needed to do the requested action." />
	...
	<body>
		...
		<div id="container">
			<div id="right">
				...
				<p style="font-family:Armata;text-align:center;">You need to be signed in to open the requested page.</p>

				<br />

				<p style="text-align:center;"><a href="index.php" style="text-decoration:none;color:#c92828;font-size:20px;font-family:Armata;">Sign In / Sign Up</a></p>
			</div>
