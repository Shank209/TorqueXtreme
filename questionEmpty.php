...
<html lang="en">
	<head>
		...
		<title>Empty Question | Torque Xtreme</title>
	...
	<body>
		...
		<div id="container">
			<div id="right">
				...
				<p style="font-family:Armata;text-align:center;">Question's title cannot be empty. If you're attaching an image, make sure it's valid and not larger than 3 MB.</p>
			</div>
