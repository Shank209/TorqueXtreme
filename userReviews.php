<?php
	...
	$query = 'SELECT id, title, votes FROM reviews WHERE userId='.$userId.' ORDER BY id DESC LIMIT '.($pageNum-1)*$itemsPerPage.', '.$itemsPerPage;
...
<html lang="en">
	<head>
		...
		<meta name="description" content="Reviews written by this user." />
	...
	<body>
		...
		<div id="container">
			<div id="right">
				<?php
					...
					{
						echo '<br /><br /><p style="font-family:Armata;text-align:center;">This user has not written any reviews yet.</p> <br />';
					}
					...
					else
					{
						...
						echo '<p id="header">Reviews written by <span>'.mysql_result($run, 0, 'username').'</span></p> <br />';
				...
				<div id="pagination">
					<?php
						...
						else if($pageNum==1)
						{
							...
							echo '|&nbsp;&nbsp;<a href="userReviews.php?pn='.$nextNum.'&id='.$userId.'">Next &gt;</a>&nbsp;&nbsp; | &nbsp;&nbsp; Go to page: <input type="text" id="pageNumInput" placeholder="'.$lastPage.'" /> &nbsp;&nbsp; <input type="button" id="goToPage" value="Go" /></p>';
						}
						else if($pageNum==$lastPage)
						{
							$prevNum = $pageNum-1;

							echo '|&nbsp;&nbsp;<a href="userReviews.php?pn='.$prevNum.'&id='.$userId.'">&lt; Prev</a>&nbsp;&nbsp; | &nbsp;&nbsp; Go to page: <input type="text" id="pageNumInput" placeholder="'.$lastPage.'" /> &nbsp;&nbsp; <input type="button" id="goToPage" value="Go" /></p>';
						}
						else
						{
							$nextNum = $pageNum+1;
							...
							echo '|&nbsp;&nbsp;<a href="userReviews.php?pn='.$prevNum.'&id='.$userId.'">&lt; Prev</a>&nbsp;&nbsp; |&nbsp;&nbsp;<a href="userReviews.php?pn='.$nextNum.'&id='.$userId.'">Next &gt;</a>&nbsp;&nbsp; | &nbsp;&nbsp; Go to page: <input type="text" id="pageNumInput" placeholder="'.$lastPage.'" /> &nbsp;&nbsp; <input type="button" id="goToPage" value="Go" /></p>';
						}
					?>
				</div>
		...
		<script type="text/javascript" src="userReviews.js"></script>
